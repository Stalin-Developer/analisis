            ...
            try {
                ...
                if ($inserted) {
                    ...
                    if (!empty($participantesData)) {
                        ...
                        $tipo = $this->request->getPost('tipo_participante'); // Autor o Coautor
                        ...
                        foreach ($participantes as $participante) {
                            ...
                            // Insertar o obtener participante
                            $participanteId = $this->insertOrGetParticipante($participanteData);
                            
                            // Crear relación
                            $this->insertProduccionParticipante($produccionId, $participanteId, $tipo);
                        }
                    }
