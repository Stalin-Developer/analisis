...
<div class="modal fade" id="modalDocentesEstudiantes" tabindex="-1" role="dialog" aria-labelledby="modalDocentesEstudiantesLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content bg-gray-light">
            <div class="modal-header bg-gradient-primary">
                <h4 class="modal-title w-100 text-center font-weight-bold" id="modalDocentesEstudiantesLabel">Tipo: <span id="tipoParticipanteSeleccionado3"></span></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body p-0">
                <!-- Sección de Docentes -->
                <div class="mb-4">
                    <div class="bg-gradient-info p-2">
                        <h4 class="text-white text-center m-0">DOCENTES</h4>
                    </div>
                    <form id="formDocentesMultiple">
                        <?php for($i = 0; $i < 10; $i++): ?>
                            <div class="row mb-3 p-2">
                                <!-- Encabezado del docente -->
                                <div class="col-12" style="background-color:rgb(114, 187, 237);">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        <label for="nombre_docente_multiple_<?= $i ?>">Nombres Completos:</label>
                                        <input type="text" class="form-control nombre-docente-multiple" 
                                               id="nombre_docente_multiple_<?= $i ?>" 
                                               name="docentes[<?= $i ?>][nombre]" 
                                               data-index="<?= $i ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        <label for="cedula_docente_multiple_<?= $i ?>">Cédula:</label>
                                        <input type="number" class="form-control cedula-docente-multiple" 
                                               id="cedula_docente_multiple_<?= $i ?>" 
                                               name="docentes[<?= $i ?>][cedula]"
                                               maxlength="10" 
                                               pattern="[0-9]{10}" 
                                               title="La cédula debe tener 10 dígitos"
                ...
                <div>
                    <div class="bg-gradient-success p-2">
                        <h4 class="text-white text-center m-0">ESTUDIANTES</h4>
                    </div>
                    <form id="formEstudiantesMultiple">
                        <?php for($i = 0; $i < 30; $i++): ?>
                            <div class="row mb-3 p-2">
                                <!-- Encabezado del estudiante -->
                                <div class="col-12" style="background-color:rgb(114, 187, 237);">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        <label for="nombre_estudiante_multiple_<?= $i ?>">Nombres Completos:</label>
                                        <input type="text" class="form-control nombre-estudiante-multiple" 
                                               id="nombre_estudiante_multiple_<?= $i ?>" 
                                               name="estudiantes[<?= $i ?>][nombre]" 
                                               data-index="<?= $i ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-0">
                                        <label for="cedula_estudiante_multiple_<?= $i ?>">Cédula:</label>
                                        <input type="number" class="form-control cedula-estudiante-multiple" 
                                               id="cedula_estudiante_multiple_<?= $i ?>" 
                                               name="estudiantes[<?= $i ?>][cedula]"
                                               maxlength="10" 
                                               pattern="[0-9]{10}" 
                                               title="La cédula debe tener 10 dígitos"
